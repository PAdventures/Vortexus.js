...
- vortexus.js - The main package found between you, the developer, and Vortexus.js's packages so that you can run a Discord app
- @vortexus.js/core - Extends the [Discord.js](https://github.com/discordjs/discord.js) module which contains our builders and managers
- @vortexus.js/utility - Utilities that are used by many if not all Vortexus.js packages
