...
Similar to [command modules](../Getting-Started/Command-Modules.mdx), events use the module system to handle events.
...
* `id` - The unique identifier for the module, explained in more detail [here](../Getting-Started/Command-Modules.mdx#id)
* `versions` - Minimum version needed to run the module, explained in more detail [here](../Getting-Started/Command-Modules.mdx#versions)
